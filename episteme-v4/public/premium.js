...
const EP = {
  ...
  // RZP_KEY is fetched from the server at runtime via /get-rzp-key
  // No secrets live in this file — all credentials are Netlify env vars
...
document.getElementById('ep-signup-btn').addEventListener('click', async () => {
  ...
  try {
    ...
    // Step 3: Open checkout — key comes from server response, never hardcoded here
